                          ...
                          <tbody>
                            <tr>
                              <td style="width:550px;">
                                <img alt="" src="{{url(Storage::url($data->travel_package->galleries[0]->image))}}" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="550" height="auto" />
                              </td>
                            </tr>
                          </tbody>
                        </table>
